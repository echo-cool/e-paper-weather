...
#include <vector>
#include <Arduino.h>
// esp_adc_cal.h was removed in ESP-IDF 5 (arduino-esp32 core 3.x). It is only
// needed for battery monitoring, which is disabled on the CrowPanel build.
...
uint32_t readBatteryVoltage()
{
  ...
  // Battery monitoring disabled (e.g. CrowPanel has no battery-voltage ADC pin).
  return UINT32_MAX;
#else
  ...
  Serial.print("[debug] ADC raw value: ");
...
const uint8_t *getForecastBitmap64(const owm_daily_t &daily)
{
  ...
  case 221: // Thunderstorm  ragged thunderstorm              11d
    if (!cloudy)
    {
      return wi_day_thunderstorm_64x64;
    }
  ...
  case 232: // Thunderstorm  thunderstorm with heavy drizzle  11d
    if (!cloudy)
    {
      return wi_day_storm_showers_64x64;
    }
  ...
  case 504: // Rain          extreme rain                     10d
    if (!cloudy && windy)
    {
      return wi_day_rain_wind_64x64;
    }
    if (!cloudy)
    {
      return wi_day_rain_64x64;
    }
    if (windy)
    {
      return wi_rain_wind_64x64;
    }
    return wi_rain_64x64;
  case 511: // Rain          freezing rain                    13d
    if (!cloudy)
    {
      return wi_day_rain_mix_64x64;
    }
  ...
  case 602: // Snow          Heavy snow                       13d
    if (!cloudy && windy)
    {
      return wi_day_snow_wind_64x64;
    }
    if (!cloudy)
    {
      return wi_day_snow_64x64;
    }
    if (windy)
    {
      return wi_snow_wind_64x64;
    }
  ...
  case 801: // Clouds        few clouds: 11-25%               02d 02n
    if (windy)
    {
      return wi_day_cloudy_gusts_64x64;
    }
                                             ...
                                             const owm_daily_t &today)
{
  ...
  bool moon = (current.dt >= today.moonrise && current.dt < today.moonset) || (today.moonrise > today.moonset && current.dt >= today.moonrise);
  ...
  case 221: // Thunderstorm  ragged thunderstorm              11d
    if (!cloudy && day)
    {
      return wi_day_thunderstorm_196x196;
    }
    if (!cloudy && !day && moon)
    {
      return wi_night_alt_thunderstorm_196x196;
    }
  ...
  case 232: // Thunderstorm  thunderstorm with heavy drizzle  11d
    if (!cloudy && day)
    {
      return wi_day_storm_showers_196x196;
    }
    if (!cloudy && !day && moon)
    {
      return wi_night_alt_storm_showers_196x196;
    }
  ...
  case 321: // Drizzle       shower drizzle                   09d
    if (!cloudy && day)
    {
      return wi_day_showers_196x196;
    }
    if (!cloudy && !day && moon)
    {
      return wi_night_alt_showers_196x196;
    }
  ...
  case 504: // Rain          extreme rain                     10d
    if (!cloudy && day && windy)
    {
      return wi_day_rain_wind_196x196;
    }
    if (!cloudy && day)
    {
      return wi_day_rain_196x196;
    }
    if (!cloudy && !day && moon && windy)
    {
      return wi_night_alt_rain_wind_196x196;
    }
    if (!cloudy && !day && moon)
    {
      return wi_night_alt_rain_196x196;
    }
    if (windy)
    {
      return wi_rain_wind_196x196;
    }
    return wi_rain_196x196;
  case 511: // Rain          freezing rain                    13d
    if (!cloudy && day)
    {
      return wi_day_rain_mix_196x196;
    }
    if (!cloudy && !day && moon)
    {
      return wi_night_alt_rain_mix_196x196;
    }
  ...
  case 602: // Snow          Heavy snow                       13d
    if (!cloudy && day && windy)
    {
      return wi_day_snow_wind_196x196;
    }
    if (!cloudy && day)
    {
      return wi_day_snow_196x196;
    }
    if (!cloudy && !day && moon && windy)
    {
      return wi_night_alt_snow_wind_196x196;
    }
    if (!cloudy && !day && moon)
    {
      return wi_night_alt_snow_196x196;
    }
    if (windy)
    {
      return wi_snow_wind_196x196;
    }
  ...
  case 613: // Snow          Shower sleet                     13d
    if (!cloudy && day)
    {
      return wi_day_sleet_196x196;
    }
    if (!cloudy && !day && moon)
    {
      return wi_night_alt_sleet_196x196;
    }
  ...
  case 701: // Mist          mist                             50d
    if (!cloudy && day)
    {
      return wi_day_fog_196x196;
    }
    if (!cloudy && !day && moon)
    {
      return wi_night_fog_196x196;
    }
  ...
  case 800: // Clear         clear sky                        01d 01n
    if (windy)
    {
      return wi_strong_wind_196x196;
    }
    if (!day && moon)
    {
      return wi_night_clear_196x196;
    }
    if (!day && !moon)
    {
      return wi_stars_196x196;
    }
  ...
  case 801: // Clouds        few clouds: 11-25%               02d 02n
    ...
    if (!day && moon)
    {
      return wi_night_alt_partly_cloudy_196x196;
    }
    if (!day && !moon)
    {
      return wi_stars_196x196;
  ...
  case 803: // Clouds        broken clouds: 51-84%            04d 04n
    if (windy && day)
    {
      return wi_day_cloudy_gusts_196x196;
    }
    if (windy && !day && moon)
    {
      return wi_night_alt_cloudy_gusts_196x196;
    }
    if (windy && !day && !moon)
    {
      return wi_cloudy_gusts_196x196;
    ...
    if (!day && moon)
    {
      return wi_night_alt_cloudy_196x196;
    }
    if (!day && !moon)
    {
...
{
#if defined(BOARD_CROWPANEL_S3)
  // On the ESP32-S3 LED_BUILTIN is GPIO48, which is the e-paper BUSY pin on the
  // CrowPanel. Driving/holding it here would break the display, so do nothing.
  return;
#else
...
/* Returns a 96x96 current-conditions bitmap. This mirrors
 * getCurrentConditionsBitmap196() but returns the smaller 96x96 icon used by
 * the dense SSD1683 (CrowPanel 4.2") layout.
 */
                                             ...
                                             const owm_daily_t &today)
{
  ...
  case 221: // Thunderstorm  ragged thunderstorm              11d
    if (!cloudy && day)
    {
      return wi_day_thunderstorm_96x96;
    }
    if (!cloudy && !day && moon)
    {
      return wi_night_alt_thunderstorm_96x96;
    }
  ...
  case 232: // Thunderstorm  thunderstorm with heavy drizzle  11d
    if (!cloudy && day)
    {
      return wi_day_storm_showers_96x96;
    }
    if (!cloudy && !day && moon)
    {
      return wi_night_alt_storm_showers_96x96;
    }
  ...
  case 321: // Drizzle       shower drizzle                   09d
    if (!cloudy && day)
    {
      return wi_day_showers_96x96;
    }
    if (!cloudy && !day && moon)
    {
      return wi_night_alt_showers_96x96;
    }
  ...
  case 504: // Rain          extreme rain                     10d
    if (!cloudy && day && windy)
    {
      return wi_day_rain_wind_96x96;
    }
    if (!cloudy && day)
    {
      return wi_day_rain_96x96;
    }
    if (!cloudy && !day && moon && windy)
    {
      return wi_night_alt_rain_wind_96x96;
    }
    if (!cloudy && !day && moon)
    {
      return wi_night_alt_rain_96x96;
    }
    if (windy)
    {
      return wi_rain_wind_96x96;
    }
    return wi_rain_96x96;
  case 511: // Rain          freezing rain                    13d
    if (!cloudy && day)
    {
      return wi_day_rain_mix_96x96;
    }
    if (!cloudy && !day && moon)
    {
      return wi_night_alt_rain_mix_96x96;
    }
  ...
  case 602: // Snow          Heavy snow                       13d
    if (!cloudy && day && windy)
    {
      return wi_day_snow_wind_96x96;
    }
    if (!cloudy && day)
    {
      return wi_day_snow_96x96;
    }
    if (!cloudy && !day && moon && windy)
    {
      return wi_night_alt_snow_wind_96x96;
    }
    if (!cloudy && !day && moon)
    {
      return wi_night_alt_snow_96x96;
    }
    if (windy)
    {
      return wi_snow_wind_96x96;
    }
  ...
  case 613: // Snow          Shower sleet                     13d
    if (!cloudy && day)
    {
      return wi_day_sleet_96x96;
    }
    if (!cloudy && !day && moon)
    {
      return wi_night_alt_sleet_96x96;
    }
  ...
  case 701: // Mist          mist                             50d
    if (!cloudy && day)
    {
      return wi_day_fog_96x96;
    }
    if (!cloudy && !day && moon)
    {
      return wi_night_fog_96x96;
    }
    return wi_fog_96x96;
  case 711: // Smoke         Smoke                            50d
  ...
  case 800: // Clear         clear sky                        01d 01n
    if (windy)
    {
      return wi_strong_wind_96x96;
    }
    if (!day && moon)
    {
      return wi_night_clear_96x96;
    }
    if (!day && !moon)
    {
      return wi_stars_96x96;
    }
  ...
  case 801: // Clouds        few clouds: 11-25%               02d 02n
    ...
    if (!day && moon)
    {
      return wi_night_alt_partly_cloudy_96x96;
    }
    if (!day && !moon)
    {
      return wi_stars_96x96;
  ...
  case 803: // Clouds        broken clouds: 51-84%            04d 04n
    if (windy && day)
    {
      return wi_day_cloudy_gusts_96x96;
    }
    if (windy && !day && moon)
    {
      return wi_night_alt_cloudy_gusts_96x96;
    }
    if (windy && !day && !moon)
    {
      return wi_cloudy_gusts_96x96;
    ...
    if (!day && moon)
    {
      return wi_night_alt_cloudy_96x96;
    }
    if (!day && !moon)
    {
      return wi_cloud_96x96;
    }
